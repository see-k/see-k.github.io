...
toc:
  - label: "Abstract"
    href: "#abstract"
  - label: "1. The problem with AGI-shaped product design"
    href: "#1-the-problem-with-agi-shaped-product-design"
  - label: "2. What DEAS is"
    href: "#2-what-deas-is"
  - label: "3. Expertise is a system property"
    href: "#3-expertise-is-a-system-property-not-a-model-property"
  - label: "4. DEAS versus AGI apps"
    href: "#4-deas-versus-agi-apps"
  - label: "5. DEAS versus vertical AI SaaS"
    href: "#5-deas-versus-vertical-ai-saas"
  - label: "6. Why cost matters"
    href: "#6-why-cost-matters"
  - label: "7. Why brand legitimacy matters"
    href: "#7-why-brand-legitimacy-matters"
  - label: "8. A finance DEAS stack in practice"
    href: "#8-a-finance-deas-stack-in-practice"
  - label: "9. DEAS in a distributed agent network"
    href: "#9-deas-in-a-distributed-agent-network"
  - label: "10. The case against fake DEAS"
    href: "#10-the-case-against-fake-deas"
  - label: "11. A practical efficacy framework"
    href: "#11-a-practical-efficacy-framework"
  - label: "12. Decision criteria for builders"
    href: "#12-decision-criteria-for-builders"
  - label: "13. Implications for DAN, Node Enterprise, and OpenClaw"
    href: "#13-implications-for-dan-node-enterprise-and-openclaw"
  - label: "14. Why this matters now"
    href: "#14-why-this-matters-now"
  - label: "15. Conclusion"
    href: "#15-conclusion"
  - label: "References"
    href: "#references"
